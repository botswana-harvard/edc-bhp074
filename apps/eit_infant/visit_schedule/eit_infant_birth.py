...
class EitInfantBirthVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['1000'] = {
        ...
        'requisitions': (
            ...
            RequisitionPanelTuple(200L, u'eit_lab', u'infantrequisition',
                                  'Plasma and Buffy Coat Storage', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(300L, u'eit_lab', u'infantrequisition',
                                  'Hematology (ARV)', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(400L, u'eit_lab', u'infantrequisition',
                                  'ELISA', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(500L, u'eit_lab', u'infantrequisition',
                                  'Chemistry NVP/LFT + ALPL6 (ARV)', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(600L, u'eit_lab', u'infantrequisition',
                                  'Viral Load', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(700L, u'eit_lab', u'infantrequisition',
                                  'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(800L, u'eit_lab', u'infantrequisition',
                                  'Pharmacokinetics', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(900L, u'eit_lab', u'infantrequisition',
                                  'CD4 (ARV)', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
        ),
        'entries': (
        )}
