...
DX_DRUG_RELATIONSHIP = (
    ...
    ('Other diagnosis CTX/NVP related)',
     'Other diagnosis possibly related to CTX/plc or NVP, specify)'),
)
...
DX = (
    ...
    ('Acute diarrheal illness (bloody diarrhean OR increase of at least '
     '7 stools per day OR life threatening for less than 14 days) ',
     'Acute diarrheal illness (bloody diarrhean OR increase of at least 7 '
     'stools per day OR life threatening for less than 14 days)'),
    ...
    ('Acute Renal failure', 'Acute Renal failure (Record highest creatinine level '
     'if tested outside of the study)'),
    ('Anemia', 'Anemia (Only report grade 3 or 4 anemia based on the lab value '
...
INFANT_DRUG_INITIATION = (
    ...
    ('congenital anomaly', ('2. Contra-indicated: Infant with congenital anomaly affecting probability '
                            'of survival to 18 months')),
...
INFANT_PRE_RANDO_LOSS_REASON = (
    ...
    ('father decision', ('7. Father of baby did not want mother/infant to participate '
                         'and participant withdrew consent')),
    ('other family member', ('8. Other family member did not want mother/infant to '
                             'participate and participant withdrew consent')),
    ...
    ('18m survival unlikely', '13. Infant diagnosed with medical conditions making survival to 18 months unlikely'),
...
INFANT_OFF_STUDY_REASON = (
    ...
    ('death', ('2. Death (complete the DEATH REPORT FORM AF005) '
               '(For EAE Reporting requirements see EAE Reporting Manual)')),
    ('refused contact', ('3. Mother of participant (or Participant\'s family) refused '
                         'further contact (explain in Comments below)')),
