...
class EitAppConfiguration(BaseAppConfiguration):
    ...
    global_configuration = {
        'dashboard': {'show_not_required_metadata': False,
                      'allow_additional_requisitions': False,
                      'show_drop_down_requisitions': True},
        'appointment': {'allowed_iso_weekdays': '12345',
    ...
    lab_setup = {
        'eit': {
            ...
            'profile': [
                ProfileTuple('Viral load (storage only)', 'WB'),
            ...
            'profile_item': [
                ProfileItemTuple('Viral load (storage only)', 'PL', 1.8, 3),
